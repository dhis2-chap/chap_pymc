...
#
# Usage:
#   python -m examples.seasonal_regression_cli train training_data.csv model.pkl config.yaml
#   python -m examples.seasonal_regression_cli predict model.pkl historic_data.csv future_data.csv predictions.csv config.yaml
#   python -m examples.seasonal_regression_cli plot model.pkl training_data.csv historic_data.csv predictions.csv config.yaml output.png
#   python -m examples.seasonal_regression_cli plot-components model.pkl config.yaml output_dir
